                ...
                @foreach($orders as $order)
                    <div class="bg-white rounded-xl shadow-sm p-6">
                        ...
                        <div class="mt-4">
                            ...
                            <div class="text-lg font-semibold">Rp {{ number_format($order->total_price, 0, ',', '.') }}</div>
                        </div>
                    ...
                    <div id="orderModal{{ $order->id }}"
                        ...
                        <div class="relative top-20 mx-auto p-5 w-full max-w-4xl">
                            <div class="relative bg-white rounded-xl shadow-lg">
                                        ...
                                        <div class="space-y-3">
                                            @if($order->orderdetail)
                                                <div class="flex justify-between items-center py-3 border-b">
                                                    <div>
                                                        <div class="font-medium">{{ $order->orderdetail->produk->nama_produk }}</div>
                                                        <div class="text-sm text-gray-500">Harga: Rp {{ number_format($order->orderdetail->produk->harga, 0, ',', '.') }}</div>
                                                    </div>
                                                    <div class="font-medium">Rp {{ number_format($order->orderdetail->produk->harga, 0, ',', '.') }}</div>
                                                </div>
                                ...
                                <div class="flex justify-between gap-3 p-4 border-t">
                                    <button type="button" onclick="closeModal('orderModal{{ $order->id }}')"
