    ...
    <div class="max-w-xs mx-auto">
        ...
        <form wire:submit.prevent="login" class="mt-6">
            ...
            <div class="flex flex-col space-y-3 mt-6">
                <!-- Login Button -->
                <x-primary-button class="w-full py-3 bg-green-500 hover:bg-green-600 text-white font-bold rounded-lg transition-all duration-300">
                    {{ __('Log in') }}
                </x-primary-button>
    
                <!-- Google Login -->
                <a href="{{ url('auth/google') }}" class="flex items-center justify-center w-full bg-[#e6f7f4] text-gray-800 font-bold rounded-lg py-3 shadow-sm transition-all duration-300 hover:bg-[#d0f0eb]">
            ...
            <div class="text-center mt-6 text-sm text-gray-600">
                @if (Route::has('password.request'))
                    <a class="underline hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" href="{{ route('password.request') }}" wire:navigate>
                        {{ __('Lupa password?') }}
                    </a>
                @endif
                <p class="mt-4">
