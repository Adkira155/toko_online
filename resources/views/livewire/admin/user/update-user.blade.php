        ...
        <div class="p-4 grid lg:grid-cols-2 gap-4">
            <div class="grid gap-4">
                <div>
                    ...
                    <x-text-input wire:model="name" id="name" name="name" type="text" class="mt-1 block w-full" value="{{$user->name}}"
                        required autofocus autocomplete="name"  />
                    <x-input-error class="mt-2" :messages="$errors->get('name')" />
                </div>
                <div>
                    <x-input-label class="required" for="email" :value="__('Email')" />
                    <x-text-input wire:model="email" id="email" name="email" type="text" class="mt-1 block w-full" value="{{$user->email}}"
                ...
                <div>
                    ...
                    <x-text-input wire:model="nomor" id="nomor" name="nomor" type="number" class="mt-1 block w-full" value="{{$user->nomor}}"
                ...
                <div>
                    ...
                    <x-text-input wire:model="role" id="role" name="role" type="text" class="mt-1 block w-full" value="{{$user->role}}"
                ...
                <div>
                    ...
                    <x-text-input wire:model="password" id="password" name="password" type="password" class="mt-1 block w-full" value="{{$user->password}}"
