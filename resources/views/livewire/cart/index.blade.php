...
<div class="bg-gray-100 min-h-screen">
    <div class="container mx-auto py-10 px-4">
        <div class="flex justify-between items-center mb-8">
            ...
            <a href="/" class="text-emerald-600 hover:text-emerald-700 flex items-center">
        ...
        <div class="flex flex-col lg:flex-row gap-8">
            ...
            <div class="w-full lg:w-96 bg-white rounded-lg shadow p-6">
                ...
                @else
                    <a href="{{ route('login') }}"
                        class="w-full bg-emerald-600 hover:bg-emerald-700 text-white py-2 px-4 rounded-lg text-center block">
                        Login to Checkout
                    </a>
                @endif
            </div>
